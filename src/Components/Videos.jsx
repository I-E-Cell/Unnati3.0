  ...
  return (
    <div className=' my-20 mx-3 relative  margin-left: 0.7em;  md:left-0'>
      ...
      <div className='flex py-20  justify-center gap-4 flex-col lg:flex-row '>
        <div className='shadoww shadow-inner relative left-3 md:left-0  w-[22em] h-[16em]  md:w-[30em] rounded-2xl md:h-[20em] bg-white/10'>
        <div className='w-[95%] h-[93%]  mx-auto my-3 rounded-2xl bg-transparent z-5'>
        ...
        <div className='shadoww w-[22em] relative left-3 md:left-0 h-[16em]  md:w-[37em] rounded-2xl md:h-[20em] bg-white/10'>
        <div className='w-[95%] h-[93%]  mx-auto my-3 rounded-2xl bg-transparent z-5'>
