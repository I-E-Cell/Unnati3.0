        ...
        <div className='mx-auto  bg-transparent shadow-lg fixed w-[100%] h-[70px] z-50'>
            ...
            <div className='bg-transparent my-auto h-[70px] flex text sticky z-50 justify-between px-8'>
                ...
                <div className='hidden bg-white/[13%] brightness-75 border-[1px] border-white/40 text-white px-6 py-3 rounded-2xl md:flex my-auto lg:gap-14 md:gap-5  backdrop-blur-md'>
                    ...
                    <a className='bg-transparent hover:-translate-y-1 md:text-sm lg:text-[15px] duration-300 ' href="">Rules</a>

                    <a className='bg-transparent hover:-translate-y-1 md:text-sm lg:text-[15px] duration-300 ' href="">Prizes</a>

                    <a className='bg-transparent hover:-translate-y-1 md:text-sm lg:text-[15px] duration-300' href="">FAQ</a>

                    <a className='bg-transparent hover:-translate-y-1 md:text-sm lg:text-[15px] duration-300' href="">Visit I&E Cell</a>
                ...
                <div className={!nav ? 'fixed left-0 top-0 w-[60%] h-[100%] border-r border-r-gray-900  backdrop-blur-md bg-white/20 ease-in-out duration-500' : 'fixed left-[-100%]'}>
                    ...
                    <div className=' gap-10 pt-20 bg-white/20 h-[100%] '>
                        ...
                        <a className='p-4 text-white bg-transparent  px-5  border-gray-600 ' href="">Home<br /> <hr className='w-[90%]  rounded-xl my-2 mx-auto' /><br /></a>
                        <a className='p-4 text-white  bg-transparent px-5 border-gray-600' href="">Rules<br /><hr className='w-[90%]  rounded-xl my-2  mx-auto' /><br /></a>

                        <a className='p-4 text-white bg-transparent px-5  border-gray-600' href="">Prizes<br /><hr className='w-[90%]  rounded-xl my-2  mx-auto' /><br /></a>
