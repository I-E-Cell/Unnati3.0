...
const Form = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Your form submission logic here, for example, making an API request to submit the form data.
  ...
  if (submitted) {
    ...
    window.location.href = "./Thankyou"; // Replace '/thank-you' with the actual URL of your thank you page.
  ...
  return (
    <div className="">
      ...
      <form
        className=" p-[15%] justify-center items-center"
        action="https://docs.google.com/forms/d/e/1FAIpQLSca4V977ujqRyG5NqUXSD22nAPlJz8kQOfTMiQ3S59GWeiTdA/formResponse"
        method="POST"
