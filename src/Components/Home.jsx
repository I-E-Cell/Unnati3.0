        ...
        <div className='relative flex bg-transparent justify-center py-[220px] md:py-[210px] gap-2 sm:gap-5'>
          <div className='flex flex-col md:flex-row'>
            <div className='flex gap-4'>
              <img
                className={`relative bg-transparent h-[56px] sm:h-[80px] lg:h-[150px] md:h-[110px] my-auto shadow-[#12E7D3] ${
                  glowingIndex === 0 ? 'glow' : ''
                }`}
                src={u}
                alt=''
            ...
            <div className='flex gap-4 sm:mt-9 md:mt-0 relative top-4 md:top-0 mx-auto'>
              <img
                className={`relative bg-transparent h-[56px] sm:h-[80px] lg:h-[150px] md:h-[110px] my-auto shadow-[#12E7D3] ml-8 ${
                  glowingIndex === 6 ? 'glow' : ''
                }`}
                src={three}
                alt=''
              />
              <img
                className={`relative justify-end bg-transparent h-[20px] mt-9 md:mt-[100px] sm:h-[25px] lg:h-[40px] md:h-[35px] my-auto shadow-[#12E7D3] ${
                  glowingIndex === 7 ? 'glow' : ''
                }`}
                src={dot}
                alt=''
